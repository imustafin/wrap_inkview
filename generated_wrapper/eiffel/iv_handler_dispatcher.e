...
feature -- Initialization
	...
	make
		...
		do
			set_iv_handler_object ($Current)
		end

feature -- Access: Routine 

	routine_1: detachable FUNCTION [TUPLE [a_type: INTEGER; a_par1: INTEGER; a_par2: INTEGER], INTEGER] 
			--Eiffel routine to be call on callback.

	routine_2: detachable FUNCTION [TUPLE [a_type: INTEGER; a_par1: INTEGER; a_par2: INTEGER], INTEGER] 
			--Eiffel routine to be call on callback.

	routine_3: detachable FUNCTION [TUPLE [a_type: INTEGER; a_par1: INTEGER; a_par2: INTEGER], INTEGER] 
			--Eiffel routine to be call on callback.
...
feature -- Access: Dispatcher
	...
	c_dispatcher_3: POINTER
		...
		do
			Result := get_iv_handler_stub_3
		end

feature -- Access: Callback

	on_callback_1 (a_type: INTEGER; a_par1: INTEGER; a_par2: INTEGER): INTEGER  
			-- Callback target.
		do
			if attached routine_1 as l_routine then 
				Result :=  l_routine (a_type, a_par1, a_par2)
			end
		end

	on_callback_2 (a_type: INTEGER; a_par1: INTEGER; a_par2: INTEGER): INTEGER  
			-- Callback target.
		do
	...
	on_callback_3 (a_type: INTEGER; a_par1: INTEGER; a_par2: INTEGER): INTEGER  
			-- Callback target.
		do
...
feature -- Register: Callbacks
	...
	register_callback_1 (a_routine: like routine_1)
		...
		do
			routine_1 := a_routine
			set_iv_handler_entry_1 ($on_callback_1)
		ensure
	...
	register_callback_2 (a_routine: like routine_1)
		...
		do
			routine_2 := a_routine
			set_iv_handler_entry_2 ($on_callback_2)
		ensure
	...
	register_callback_3 (a_routine: like routine_1)
		...
		do
			routine_3 := a_routine
			set_iv_handler_entry_3 ($on_callback_3)
		ensure
...
feature {NONE} -- Implementation
	...
	dispose
		...
		do
			...
			set_iv_handler_object (default_pointer)
		end
